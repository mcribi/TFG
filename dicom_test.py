...
########################### Datos categoricos y numericos Excel ##################################
#lectura del csv
...
# ---------------------------- MAIN ----------------------------
def main():
    # Para el path hay que acceder al archivo DICOMDIR (al Slicer en cambio parece que se le pasa el directorio)
    ...
    # # Manejar el conjunto de archivos
    # fs = FileSet(dsdir)

    # print(fs)

    # # Accediendo a los datos y dibujando
    ...
    root_path = "./casosradiomica/"  # Directorio raíz que contiene los pacientes
    ...
    for patient_dir in patient_dirs:
        ...
        try:
            ...
            for instance in fs:
                ...
                # Obtener el nombre y el ID del paciente (si no se ha obtenido previamente)
