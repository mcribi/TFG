...
# ----------------------------
# 3. Grid de parámetros equilibrado
# ----------------------------
param_grid = {
...
# ----------------------------
# 4. Crear archivo CSV para guardar resultados
# ----------------------------
with open("resultados_xgboost_optimizados.csv", "w", newline="") as f:
    writer = csv.writer(f)
    writer.writerow([
    ...
    for i, params in enumerate(grid, 1):
        ...
        # Guardar los resultados promediados
        writer.writerow([
