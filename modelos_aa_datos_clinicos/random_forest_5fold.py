...
for fold, (train_idx, test_idx) in enumerate(skf.split(X_scaled, y), 1):
    ...
    model = XGBClassifier(
        ...
        eval_metric='logloss',
        scale_pos_weight=6.0 # equivalente a class_weights [1, 2]
    )
...
# ----------------------------
# 5. Importancia de características (promedio)
# ----------------------------
...
plt.title("Importancia Media de Características (XGBoost - 5-Fold)")
plt.tight_layout()
plt.show()
