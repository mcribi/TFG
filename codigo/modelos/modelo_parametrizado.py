...
def train_model(
    ...
    for epoch in range(epochs):
        ...
        if save_path:
            if epoch == 0:
                # en la primera epoca guardamos siempre para que no haya error de que nunca mejora y despues no exista
...
for prep in preprocessing_dirs:
    ...
    for bs in batch_sizes_to_try:
        for lr in learning_rates_to_try:
            ...
            # añadmos columna del preprocesado
