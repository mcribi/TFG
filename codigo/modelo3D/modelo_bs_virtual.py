...
train = pd.read_csv("./../../datos_clinicos/datos_clinicos.csv", na_values="NaN", sep = ",") # Definimos na_values para identificar bien los valores perdidos
...
# Mapear a índices del dataset original
...
def train_model_bs_virtual(
    ...
    # Evaluar modelo final (validación + test)
    if save_path:
...
def cross_validate(
    ...
    # Sacar etiquetas para stratificar
    ...
    # Evaluar todos los modelos en TEST fijo
